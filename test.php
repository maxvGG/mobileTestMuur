...
foreach (getUrlTestCases() as $url) {
    echo 'input: ' . $url . PHP_EOL . "<br>";
    echo 'filter_var: ' . printValidation(filter_var($url, FILTER_VALIDATE_URL)) . PHP_EOL . "<br>";
    echo 'parse_url: ' . printValidation(parse_url($url, PHP_URL_SCHEME) && parse_url($url, PHP_URL_HOST)) . PHP_EOL . "<br>";
